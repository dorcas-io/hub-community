var app = {
    ...
    formatters: {
        access_grants: function (row, index) {
            ...
            row.modules_count = typeof row.extra_json.modules !== 'udnefined' ? row.extra_json.modules.length : 0;
            row.pending_modules_count = typeof row.extra_json.pending_modules !== 'udnefined' ? row.extra_json.pending_modules.length : 0;
            row.menu = '';
